#ifndef PROCRELEASECHECKER_H
#define PROCRELEASECHECKER_H

#include <QObject>
#include <QStringList>

#define PROC_RELEASES "https://github.com/procommerce-io/procurrency/releases"
...
class ProcReleaseChecker : public QObject
{
    Q_OBJECT
public:
    explicit ProcReleaseChecker(QObject *parent = 0);
    ~ProcReleaseChecker();
