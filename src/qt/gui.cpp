...
#ifdef Q_OS_WIN
    QFile html("C:/procurrency/index.html");
#else
    QFile html("/opt/procurrency/index.html");
#endif
...
void GUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About ProCurrency"), this);
    aboutAction->setToolTip(tr("Show information about ProCurrency"));
...
void GUI::setClientModel(ClientModel *clientModel)
{
    ...
    if (clientModel)
    {
        ...
        if (mode != NT_FULL)
        {
            ...
            setWindowTitle(tr("ProCurrency") + " - " + tr("Wallet") + ", " + sMode);
        };
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/procurrency_testnet"));
            setWindowIcon(QIcon(":icons/procurrency_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/procurrency_testnet"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("ProCurrency client") + QString(" ") + tr("[testnet]"));
                trayIcon->setIcon(QIcon(":/icons/procurrency_testnet"));
...
void GUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("ProCurrency client"));
    trayIcon->setIcon(QIcon(":/icons/procurrency"));
    ...
    QString strMessage =
        tr("This transaction is over the size limit.  You can still send it for a fee of %1, "
          ...
          "Do you want to pay the fee?").arg(
                BitcoinUnits::formatWithUnit(BitcoinUnits::PROC, nFeeRequired));
