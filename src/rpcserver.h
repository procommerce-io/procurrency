...
extern json_spirit::Value sendproctotoken(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value sendtokentotoken(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value sendtokentoproc(const json_spirit::Array& params, bool fHelp);
